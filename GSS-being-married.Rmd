...
focused_data <- focused_data %>% 
  ...
  mutate(age_range = case_when(floor(age) > 60 ~ "Above 60",
                              floor(age) >= 50 & floor(age) <= 60 ~ "50-60",
                              floor(age >= 40)  & floor(age) <= 49 ~ "40-49",
                              floor(age) >= 30  & floor(age) <= 39 ~ "30-39",
                              floor(age) >= 18  & floor(age) <= 29 ~ "18-29",
                              floor(age) < 18 ~ "Below 18"))
focused_data$age_range <- factor(focused_data$age_range,levels =c("Below 18", "18-29", "30-39", "40-49", "50-60","Above 60"),ordered = TRUE) #order the input so that the bar chart is in order
