...
# Weaknesses
Possible weaknesses in this paper lie within the scope of our data set. Inaccuracy could occur sue to only taking two variables into consideration while many others werre left out. This was done as a measure to lower complexity but could also be seen as a point of weakness as more variables would increase its accuracy. The GSS uses  Age-Order method over traditional household rostering method. Based on a reseach about alternative methods for the random selection of a respondent within a household for online surveys (@citeageorder), this method have some drawbacks on the accuracy of the data.
